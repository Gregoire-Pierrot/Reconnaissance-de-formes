...
#from model import predict_image_from_directory
...
save_processed_image(
    input_image_path="../resources/dataset/augmented_dataset/2/IMG_1120_a0_blur_down_12.jpg",
    output_image_path="../resources/results/image_traitee.jpg"
)
